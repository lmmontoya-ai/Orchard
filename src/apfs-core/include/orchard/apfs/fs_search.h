...
[[nodiscard]] BtreeWalker::CompareFn
MakeFileExtentLowerBoundCompare(std::uint64_t inode_id, std::uint64_t logical_address = 0U);
...
[[nodiscard]] blockio::Result<bool> IsDirectoryRecordKeyFor(std::span<const std::uint8_t> key_bytes,
